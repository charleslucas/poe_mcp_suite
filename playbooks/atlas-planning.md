...
| Source | Tool | Why |
|---|---|---|
| **Pre-flight** | See [`README.md`](README.md) section 2 — `get_context_usage` + league reference + character snapshot. If already at 60%+ skip the atlastree Python query and rely on cached node names. | |
