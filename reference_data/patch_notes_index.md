...
|---|---|---|---|---|
| **3.29.3 Hotfixes 1–2** | Hotfix | https://www.pathofexile.com/forum/view-thread/3996584 · https://www.pathofexile.com/forum/view-thread/3996608 (2026-08-12) | — | Currency Exchange text size, instance crash, Trade Market translation. **No build impact.** |
| **3.29.3** | Point release | https://www.pathofexile.com/forum/view-thread/3996516 (2026-08-12) | — | 6 new Cursed Ducats for the Voyage Planner, border-modifier keybind, further enemy-mercenary damage nerfs. ⚠ **THREE build-relevant items:** (a) **Small Cluster Jewel modifiers can now be swapped via Genteel's Ducat** — a new deterministic crafting route; (b) **fixed Pact of Ghorr not empowering Desecrate**; (c) **fixed Pearl of Tsoatha unequipping sometimes despawning spectres**. (b) and (c) are minion/spectre behaviour. ⚠ **PoB 2.67.2 predates this patch.** |
| **3.29.2 Hotfix 3** | Hotfix | https://www.pathofexile.com/forum/view-thread/3995749 (2026-08-09) | — | Valdo map Bismuth ore completion; Impenetrable Bastion mercenary cooldown scaling. **No build impact.** |
| **3.29.2 Hotfix 2** | Hotfix | https://www.pathofexile.com/forum/view-thread/3994902 (2026-08-06) | — | ⚠ **Unique rework:** **Hand of the Fervent** — Sacrificial Zeal now grants Added Spell Damage equal to 25% of the skill's mana cost, capped at max spendable. Single-change patch. |
| **3.29.2** (+ Hotfix 1) | Point release | https://www.pathofexile.com/forum/view-thread/3994431 · hotfix https://www.pathofexile.com/forum/view-thread/3994498 (2026-08-05) | — | Large league QoL pass (Allflame capsules, altar conversion rates, chart mods → item rarity), crafting bench in the Menagerie, enemy-mercenary damage nerfs, Abyss drop/XP buffs. ⚠ **Two behaviour changes:** **From Below** ascendancy notable now prevents **all** forms of recovery (bug fix, but real behaviour); Chromatic Orb + Abyssal Socket interaction. No skill/gem/tree balance. |
| **3.29.1** (+ Hotfix, + Maintenance) | Point release | https://www.pathofexile.com/forum/view-thread/3991672 · hotfix https://www.pathofexile.com/forum/view-thread/3991769 · maint https://www.pathofexile.com/forum/view-thread/3991893 (2026-07-30) | — | League (Charts/Voyages/Dredge) improvements, mercenary balance, new Atlas notable **Contract Killers**, bug fixes. ⚠ **MINION-RELEVANT:** **`Coursing Current Support` can now support Minions and their Skills** — a new support option for every minion build. Also Crab Totem AI fix, Hydrosphere stat-display fix. No tree/ascendancy/unique changes. |
| **3.29.0 Hotfixes 2–3** | Hotfix | https://patchbot.io/games/path-of-exile/articles/924-3290-hotfix-3 (mirror; ~2026-07-28) | — | Post-3.29.0b client patches. ⚠ **Abyss-socket enforcement:** items with MORE Abyssal Sockets than their explicit mods allow are **disabled/unequippable**; illegal empty sockets auto-convert to white on login (relevant to Stygian Vise / Darkness Enthroned users). Also: Sovereign's Lantern auto-placement reliability, longer Chart escape timers, client/server crash fixes, Mercenary-spawn blockages in Toxic Conduit. **No build-mechanic changes** — indexes unaffected. Checked 2026-07-31; index swept forward to 3.29.3 on 2026-08-11. |
